...
public class Projects {
    ...
    public Long getPsMoney() {
        return psMoney;
    }

    public void setPsMoney(Long psMoney) {
    ...
    public Long getPsGetmoney() {
        return psGetmoney;
    }

    public void setPsGetmoney(Long psGetmoney) {
